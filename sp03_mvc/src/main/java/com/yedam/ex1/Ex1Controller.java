...
import com.yedam.ex3.EmpVO;
import com.yedam.ex3.Member;
...
public class Ex1Controller {
	...
	@PostMapping("/file")
	public String file(EmpVO vo,
			           @RequestPart("profile") MultipartFile file,
			           @RequestPart("contract") MultipartFile contract) throws IllegalStateException, IOException {
